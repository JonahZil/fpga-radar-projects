...
//Date        : Fri Jul 17 14:16:17 2026
//Host        : Exez running 64-bit major release  (build 9200)
//Command     : generate_target updated_design.bd
//Design      : updated_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "updated_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=updated_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=1,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "updated_design.hwdef" *) 
module updated_design
   (CS_N,
    DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  updated_design_BGT_AXI_slave_0_0 BGT_AXI_slave_0
       (.CS_N(CS_N),
        .IRQ(IRQ),
        .MISO(MISO),
        .MOSI(MOSI),
        ...
        .start(start));
  updated_design_axi_smc_0 axi_smc
  ...
  updated_design_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  updated_design_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
