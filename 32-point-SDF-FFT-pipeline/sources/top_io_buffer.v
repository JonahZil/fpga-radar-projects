module top_io_buffer (
    ...
    wire signed [31:0] bram_data_i;
    wire signed [31:0] bram_data_o;
    ...
    sdf_fft_32 fft (
        ...
        .data_real(bram_data_o[31:16]),
        .data_imag(bram_data_o[15:0]),
        ...
        if (rst) begin
            ...
            case (state)
                ...
                STATE_LOAD: begin
                    ...
                    if (in_valid && load_counter < 32) begin
                        write_address <= write_address + 1;
                        load_counter <= load_counter + 1;
                    end
                    
                    if(load_counter == 6'd32) begin
                        state <= STATE_FFT;
                        write_address <= 0;
                        read_address <= 0;
                        read_issue_counter <= 0;
                ...
                STATE_FFT: begin
                    if (read_issue_counter < 32) begin
                        read_address <= read_issue_counter[4:0];
