...
`timescale 1 ns / 1 ps
	...
	wire signed [31:0] buf_in_data;
	wire buf_in_valid;
	wire buf_out_ready;
	
	wire signed [31:0] buf_out_data;
    wire               buf_out_valid;
    wire               buf_in_ready;
    
// Instantiation of Axi Bus Interface S00_AXI
	fft_ip_slave_lite_v1_0_S00_AXI # ( 
        .C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
        .C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
    ) fft_ip_slave_lite_v1_0_S00_AXI_inst (
    ...
    top_io_buffer buffer (
        .clk(s00_axi_aclk),
        .rst(~s00_axi_aresetn),
    
        .in_data(buf_in_data),
        .in_valid(buf_in_valid),
