...
(* CORE_GENERATION_INFO = "block_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=block_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,da_board_cnt=7,da_ps7_cnt=7,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "block_design.hwdef" *) 
module block_design
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  block_design_fft_32_point_0_0 fft_32_point_0
       (.s00_axi_aclk(Net),
